// Tracing Options
pref("extensions.firebug.DBG_FBS_JSDCONTEXT", false);   // firebug trace scriptinfo(huge)
pref("extensions.firebug.DBG_FBS_FF_START", false);     // firebug trace from FF start(huge)
...
pref("extensions.firebug.DBG_CSS_PARSER", false);       //
pref("extensions.firebug.DBG_DBG2FIREBUG", false);      //
